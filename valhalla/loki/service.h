  ...
  namespace loki {
    ...
    class loki_worker_t {
     ...
     protected:
      ...
      prime_server::worker_t::result_t jsonify_error(unsigned status_code, const uint64_t error_code, const std::string& error, prime_server::http_request_t::info_t& request_info) const;
